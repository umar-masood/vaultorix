...
VaultWindow::VaultWindow(QWidget *parent) : Window(parent) {
  ...
  connect(updates_download_btn, &Button::clicked, this, [this]{
    if (!au) {
        ...
        au->setDarkMode(ThemeManager::instance().isDarkMode());
  ...
  connect(preferences_btn, &Button::clicked, this, [this](){
    if (!pref) {
      ...
      pref->setDarkMode(ThemeManager::instance().isDarkMode());
  ...
  connect(about_btn, &Button::clicked, this, [this] {
    if (!about) {
        ...
        about->setDarkMode(ThemeManager::instance().isDarkMode());
  ...
  connect(report_bug_btn, &Button::clicked, this, [this](){
    if (!report_bug) {
        ...
        report_bug->setDarkMode(ThemeManager::instance().isDarkMode());
...
void VaultWindow::setDarkMode(bool isDarkMode) {
  ...
  isDarkMode ? theme_mode_btn->setIconPaths(LightModeIcon, LightModeIcon) : theme_mode_btn->setIconPaths(DarkModeIcon, DarkModeIcon);
  ...
  // Statusbar theme
  _statusbar->setDarkMode(isDarkMode);
}
