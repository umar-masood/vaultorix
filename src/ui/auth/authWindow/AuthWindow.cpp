                        ...
                        SubWindow(QSize(1000, 720), nullptr, true, true), rightWidget(rightWidget) 
{
   ...
   // Theme Connection
   connect(this, &AuthWindow::themeModeChanged, this, &AuthWindow::onthemeModeChanged);   
}

/* --------------------  Setters  -----------------  */
void AuthWindow::setDarkMode(bool value) {
   if (isDarkMode == value)
      return;
...
void AuthWindow::onthemeModeChanged(bool enable) {
